...
export default function NameChangeModal({show, hide, changeName, index, maxLength}) {
    ...
    return (
        <div className={showHideClassName}>
            <section className='modal-main'>
                ...
                <input id={"nameChangeInput" + index} data-testid="nameChangeInput" maxLength={maxLength} ></input>
